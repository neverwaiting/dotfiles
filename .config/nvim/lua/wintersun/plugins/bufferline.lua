require("bufferline").setup {
	options = {
		...
		-- true | false, whether or not to add the filetype icon highlights
		color_icons = true,
		-- true | false, disable filetype icons for buffers
		show_buffer_icons = true,
		show_buffer_close_icons = false, -- true | false
		-- true | false, whether or not an unrecognised filetype should show a default icon
		...
		-- 'insert_after_current' |'insert_at_end' | 'id' | 'extension' | 'relative_directory' | 'directory' | 'tabs' |
			-- function(buffer_a, buffer_b) sort_by = 'insert_after_current'
			-- 	-- add custom logic

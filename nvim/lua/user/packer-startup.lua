...
local mirror_github_url = 'https://github.91chi.fun/' .. github_url

local function get_real_github_url(enable_proxy)
	if enable_proxy then
		return mirror_github_url
	else
		return github_url
	end
end
...
local function ensure_packer()
  ...
  if fn.empty(fn.glob(install_path)) > 0 then
    fn.system({
			...
			'--depth',
			'1',
			get_real_github_url(true) .. 'wbthomason/packer.nvim',
			install_path
		})
...
-- default_config
local plug_url_format = 'https://github.91chi.fun/https://github.com/%s.git'
